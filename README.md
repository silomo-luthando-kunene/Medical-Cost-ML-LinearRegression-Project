...
## 🛠️ Project Lifecycle
1. Exploratory Data Analysis: I investigated the relationship between the independent variables and the target variable (charges).
...
Tags: #machine-learning #regression #python #scikit-learn #data-science
